  ...
  return (
    <section id="home" className="relative min-h-screen overflow-hidden px-4 sm:px-6 lg:px-8">
      ...
      <div className="relative z-10 mx-auto flex min-h-screen max-w-6xl flex-col items-center justify-center pb-20 pt-24 text-center">
        <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.1, duration: 0.75 }} className="w-full">
          <p className="mb-2 font-mono text-xs tracking-[0.28em] text-gray-600">HELLO, WORLD. I AM</p>
          <ParticleName text="HADI ABDULLA" height={260} className="mx-auto w-full max-w-6xl px-2" />
